...
/**
 * Represents a message that a real Dyena box would send to a server. In this simulator
 * data is read from a *.csv file, some of the data is computed and assigned to this <code>Message</code> object.
 * <p>
 * Messages from Dyena box are send in JSON. One JSON object is one message.  Majority of this class was 
 * generated by org.jsonschema2pojo from a JSON object received from a Dyena box 
 * in order to be able to serialise data read from  *.csv file into the exact JSON format
 * as expected by a server.
 *
...
public class Message
{
    ...
    /**
     * Constructor taking deserialized JSON objects as parameters.
    ...
    /**
     * Constructor taking fields of deserialized JSON objects as parameters.
     * @param line Data of a single line from the *.csv file
     ...
     * @param sog Vessel's speed over ground
     * @param cog Vessel's course over ground
     * @param rpm Vessel's engine's resolutions per minute
     * @param fph Vessel's fuel consumption per hour
     * @param th Vessel's throttle
     */ 
    
    public Message(Line line, int vid, double[] hve, double[] pit, double[] rol, double[] hed, double[] ax, double[] ay, double[] az, double sog, double cog, int rpm, double fph, int th)
    {
        //setting the current time instead of the ones in the *.csv files
        DateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss.sss");
	Date date = new Date();  
        this.bt = 257;
        
        this.head = new Head(vid, dateFormat.format(date), line.getLatitude(), line.getLongitude(), sog ,cog, 257);
         ...
         */
        this.eng = new Eng(fph, fph, rpm, rpm, th, th);
        /*
    ...
    public class Head
    {
        ...
        /**
         * No args constructor for use in serialisation to JSON.
         */
        public Head()
        {
        }
        ...
        /**
         * @param vid Vessel's identification number.
         ...
         */
        public Head(Integer vid, String dt, Float lat, Float lon, double sog, Double cog, Integer sta)
        {
            this.vid = vid;
            this.dt = dt;
            this.lat = lat;
    ...
    public class Vmms
    {
        ...
        /**
         * This constructor calculates the root mean square for hve, pit and rol 
         * @param hve One seconds worth of heave values (25 in total).
         * @param pit One seconds worth of pitch values (25 in total).
         * @param rol One seconds worth of roll values (25 in total).
         * @param hed One seconds worth of heading values (25 in total).
